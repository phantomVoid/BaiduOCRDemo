 ...
 * <li>{@link #getLast(Object[], Object, Object, boolean)} get last element of the target element, before the first one that match the target element front to back</li>
 * <li>{@link #getNext(Object[], Object, Object, boolean)} get next element of the target element, after the first one that match the target element front to back</li>
